...
namespace ProAzureCommonLib
{
    public class WASystemHelper
    {
        ...
        public static bool Cleanup(string localJobFilesPath)
        {
            try
            {
                Directory.Delete(localJobFilesPath, true);
            }
            catch (Exception)
            {
                return false;
        ...
        #region Database
        public static string InitUserDbString()
        {
