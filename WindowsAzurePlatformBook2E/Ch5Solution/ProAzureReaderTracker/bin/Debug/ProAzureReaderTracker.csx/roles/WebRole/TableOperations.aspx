        ...
        <table style="border: thin solid #800080; width: 100%;">
            ...
            <tr>
                <td class="style2">
                    &nbsp;</td>
                <td>
         <asp:LinkButton ID="lbCreateProAzureTable" runat="server" 
                        onclick="lbCreateProAzureTable_Click">Create ProAzureReader Table</asp:LinkButton>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style2" valign="top">
                    &nbsp;</td>
                <td>
                    <asp:LinkButton ID="lbDeleteProAzureTable" runat="server" 
                        onclick="lbDeleteProAzureTable_Click">Delete ProAzureReader Tables</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td class="style2" valign="top">
